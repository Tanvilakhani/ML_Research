...
import psutil  # For CPU core affinity
import tensorflow as tf  # For threading control
from tensorflow.keras.models import load_model
from tensorflow.keras.applications.efficientnet import preprocess_input

# === LIMIT TO SPECIFIC CPU CORES AND THREADS ===
p = psutil.Process(os.getpid())
p.cpu_affinity([0, 1, 2, 3])  # Adjust the core IDs as needed
...
model_path = 'checkpoints_efficientnetb0/efficientnetb0_best.h5'
