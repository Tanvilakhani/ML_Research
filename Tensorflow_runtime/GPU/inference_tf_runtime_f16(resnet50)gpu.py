...
MODEL_PATH = 'Tensorflow_runtime/Models/Fp16/resnet50_fp16.h5'  # ResNet50 FP16 model
...
def preprocess_image(image_path):
    ...
    img_np = preprocess_input(img_np)  # ResNet50 preprocessing
...
summary = {
    ...
    "Optimization Option": "FP16 Inference"
}
