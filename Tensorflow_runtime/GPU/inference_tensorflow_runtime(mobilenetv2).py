...
p.cpu_affinity([0, 1])  # Use 2 cores, adjust as needed
tf.config.threading.set_intra_op_parallelism_threads(2)  # Number of threads used within operations
tf.config.threading.set_inter_op_parallelism_threads(1)  # Number of threads used between operations
