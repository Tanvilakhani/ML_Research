# -*- coding: utf-8 -*-
"""fp16_tflite_efficientnetb0_cpu.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1vn6KoJHACCqzzJioHQvvdRi6JHhlDVHz
"""
...
MODEL_PATH = '/content/drive/MyDrive/models/int8_tflite/efficientnetb0_fp16.tflite'  # FP16 TFLite model
ARCHITECTURE = "efficientnetb0"
FORMAT_TYPE = "TFLite_fp16"
RUNTIME = "TFLite"
NUM_REPEATS = 100
DEVICE = "CPU"
...
TXT_REPORT_PATH = os.path.join(REPORT_DIR, f"tflite_fp16_{os.path.splitext(os.path.basename(MODEL_PATH))[0]}.txt")
