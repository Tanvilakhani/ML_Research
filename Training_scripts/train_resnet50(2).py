...
# File paths
# -----------------------
MODEL_PATH = 'models/resnet50_fruits_trained(3).keras'
CSV_PATH = 'results/report/resnet50_training_history(3).csv'
REPORT_PATH = 'results/report/resnet50_classification_report(3).txt'
METRICS_PLOT_PATH = 'results/metrics/resnet50_training_metrics(3).png'
CONF_MATRIX_PATH = 'results/metrics/resnet50_confusion_matrix(3).png'
CHECKPOINT_DIR = 'checkpoints_resnet50(3)'
...
checkpoint_callback = ModelCheckpoint(
    filepath=os.path.join(CHECKPOINT_DIR, 'resnet50_best(3).keras'),
