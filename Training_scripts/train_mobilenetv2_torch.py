...
MODEL_SAVE_PATH = r'Models/mobilenetv2_fruits_scripted(2).pt'
REPORT_SAVE_PATH = r"results/mobilenetv2_classification_report_torchscript(2).txt"
CONF_MATRIX_SAVE_PATH = r"results/mobilenetv2_confusion_matrix_torchscript(2).png"
