...
model_path = 'resnet50_fruits_trained.h5'
...
# Use tqdm progress bar over all images
for img_path, true_class in tqdm(zip(image_paths, image_labels), total=len(image_paths), desc="Processing Images"):
    ...
    # Start timing before repeated inference
...
# === Save to TXT ===
txt_report_path = "inference_report.txt"
with open(txt_report_path, "w") as f:
    f.write("=== Keras Inference Report ===\n")
...
# === Save to CSV ===
csv_report_path = "simple_inference_summary_resnet.csv"
