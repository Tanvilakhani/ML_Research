...
model_xml_path = 'Models/resnet50_fruits.xml'  # OpenVINO IR XML model
architecture = "ResNet50"
format_type = "OpenVINO IR"
runtime = "OpenVINO"
num_repeats = 100
device = "CPU"  # Change if you want GPU etc.
