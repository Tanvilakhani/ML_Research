...
import time
import datetime
from networkx import Graph  # not used, but kept to match your original script
import numpy as np
import pandas as pd
...
model_xml_path = 'Models/mobilenet_v2.xml'  # MobileNetV2 OpenVINO IR XML model
architecture = "MobileNetV2"
format_type = "OpenVINO IR"
runtime = "OpenVINO"
num_repeats = 100
device = "CPU"  # Change to "GPU" or "AUTO" if needed
